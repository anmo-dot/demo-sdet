...
public class WebOrder_Login_CreateOrder_Screenshot_BaseClass {
	ChromeDriver driver;
	...
	public void CaptureScreenShot(ITestResult result) throws Exception {
		if (ITestResult.FAILURE == result.getStatus()) {
			BaseClassMain.getScreenshotfailure(driver, result.getName());
			
		}
		else if (ITestResult.SUCCESS == result.getStatus()) 
		{
			BaseClassMain.getScreenshotSuccess(driver, result.getName());
		}
